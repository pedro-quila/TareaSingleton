...
public class sRegistro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h3>Registro de Alumnos</h3>");
            String rut = request.getParameter("rut");
            String nom = request.getParameter("nom");
            String ap = request.getParameter("ap");
            int ed = Integer.parseInt(request.getParameter("ed"));
            
            String rt = controlAlumno.validarRut(rut);
            if (rt != null) {
                out.println(controlAlumno.agregarAlumno(rut, nom, ap, ed, 1, 1, 1, 1));
            }else{
                out.print("El Rut ingresado ya existe. Reintentar");
            }
