 ...
 * @author pedro.quila
 */
@WebServlet(name = "sModificar", urlPatterns = {"/sModificar"})
public class sModificar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h3>Modificar Alumno</h3>");
            String rut = request.getParameter("rut");
            String nom = request.getParameter("nom");
            String ap = request.getParameter("ap");
            int ed = Integer.parseInt(request.getParameter("ed"));
            out.println(controlAlumno.modificarAlumno(rut, nom, ap, ed));
            
            out.print("<form action=sListado>");
